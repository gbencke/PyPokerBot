...
class NeedToSpecifySeatsException(Exception):
    ...
    def __init__(self, message):
        super(NeedToSpecifySeatsException, self).__init__(message)
...
class MoreThanOneLobbyPerPlatformException(Exception):
    ...
    def __init__(self, message):
        super(MoreThanOneLobbyPerPlatformException, self).__init__(message)
...
class NeedToSpecifyTableTypeException(Exception):
    ...
    def __init__(self, message):
        super(NeedToSpecifyTableTypeException, self).__init__(message)

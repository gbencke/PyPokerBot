...
class Settings(object):
    ...
    @staticmethod
    def get_table_scanner_class(image_platform):
        """
    ...
    @staticmethod
    def get_command_test_template(platform, tabletype, current_command):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if is a certain
        command on a certain position
    ...
    @staticmethod
    def get_command_size(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if is a certain
        command on a certain position
    ...
    @staticmethod
    def get_button_threshold(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if the button is
    ...
    @staticmethod
    def get_button_size(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if the button is
    ...
    @staticmethod
    def get_has_unknown_card_template(platform):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
    ...
    @staticmethod
    def get_comand_pos(platform, tabletype, current_command):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
        a table seat has unknown cards.
    ...
    @staticmethod
    def get_flop_has_nocard_template(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
    ...
    @staticmethod
    def get_play_hascard_threshold(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
        the table flop has a card
    ...
    @staticmethod
    def get_player_hascard(platform, tabletype, index):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
    ...
    @staticmethod
    def get_bet(platform, tabletype, index):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
    ...
    @staticmethod
    def get_playerhascard_size(platform, tabletype):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if a certain position on
    ...
    @staticmethod
    def get_pot_pos(platform, tabletype):
        """
    ...
    @staticmethod
    def get_command_pos(platform, tabletype, pos):
        """
        The Pokerbot uses a series of templates in order to analyse the image on
        poker client, this template is the one used to determine if is a certain
        command on a certain position
    ...
    @staticmethod
    def get_raw_image_size(image_platform, image_tabletype, image_size):
        """
